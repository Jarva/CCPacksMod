...
public class SelectableButtonWidget extends ButtonWidget {
    ...
    public SelectableButtonWidget(Choice choice, ItemStack itemStack, ItemRenderer itemRenderer, int x, int y, int width, int height, Text text, int u, int v, int hoveredVOffset, Identifier texture, int textureWidth, int textureHeight, ButtonWidget.PressAction onPress) {
